...
from physics_atv_visual_mapping.image_processing.processing_blocks.distilled_model import DistilledModelBlock
...
from physics_atv_visual_mapping.image_processing.processing_blocks.identity import IdentityBlock
...
def setup_image_pipeline(config):
    ...
    for block_config in config['image_processing']:
        ...
        elif btype == 'distilled_model':
            block = DistilledModelBlock(**block_config['args'])
        elif btype == 'sam':
        ...
        # elif btype == 'ganav':
            ...
            block = IdentityBlock(**block_config['args'])
        else:
