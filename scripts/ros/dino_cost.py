...
class LethalHeightCost(object):
    ...
    def run_map(self, event):
        ...
        if self.odom_msg is not None:
            ...
            height_threshold = -0.5 # TODO: need to handle height of camera
            costmap = gridmap_height
            costmap[gridmap_height > height_threshold] = 10
            # costmap[:,:] = 0
...
def main():
    ...
    costmap_topic = '/cherie_costmap' #rospy.get_param("~costmap_topic")
