...
def double_conv_k3(in_channels, out_channels):
    return nn.Sequential(
...
def double_conv_k5(in_channels, out_channels):
    return nn.Sequential(
...
def up_conv_two(in_channels, out_channels):
    return nn.ConvTranspose2d(
        in_channels, out_channels, kernel_size=2, stride=2, padding=0, output_padding=0
    )
    
def up_conv_three(in_channels, out_channels):
    return nn.ConvTranspose2d(
        in_channels, out_channels, kernel_size=3, stride=3, padding=0, output_padding=0
    )

def upsample_two_conv(in_channels, out_channels):
    return nn.Sequential(
...
# def up_conv_three(in_channels, out_channels):
#     return nn.ConvTranspose2d(
#         in_channels, out_channels, kernel_size=5, stride=3, padding=2, output_padding=2
#     )

class InterpolateArea(nn.Module):
    def __init__(self, size=None, scale_factor=None):
        super(InterpolateArea, self).__init__()
        self.size = size
...
class InterpolateBilinear(nn.Module):
    def __init__(self, size=None, scale_factor=None, align_corners=False):
        super(InterpolateBilinear, self).__init__()
        self.size = size
        self.scale_factor = scale_factor
        self.mode = 'bilinear'
